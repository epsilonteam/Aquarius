package net.spartanb312.aquarius.event
...
import net.spartanb312.aquarius.util.threads.defaultScope
import net.spartanb312.aquarius.util.threads.runSafe
import net.spartanb312.aquarius.util.threads.runSafeSuspend
import java.util.concurrent.atomic.AtomicInteger
import java.util.function.Consumer

const val DEFAULT_LISTENER_PRIORITY = 0

inline fun <reified E : Any> Any.safeListener(
