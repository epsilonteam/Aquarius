...
object ChatUtil : Helper {
    ...
    fun printChatMessage(message: String) {
        printRawChatMessage(SECTION_SIGN + "7[" + SECTION_SIGN + "b" + Aquarius.MOD_NAME + SECTION_SIGN + "7] " + SECTION_SIGN + "r" + message)
    }

    fun printWarnChatMessage(message: String) {
        printRawChatMessage(SECTION_SIGN + "7[" + SECTION_SIGN + "6Warn" + SECTION_SIGN + "7] " + SECTION_SIGN + "r" + message)
    }
