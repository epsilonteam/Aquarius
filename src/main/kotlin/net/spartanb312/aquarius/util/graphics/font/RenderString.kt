package net.spartanb312.aquarius.util.graphics.font

import net.spartanb312.aquarius.util.graphics.font.glyph.CharInfo
import net.spartanb312.aquarius.util.graphics.font.glyph.GlyphChunk
import net.spartanb312.aquarius.util.graphics.font.renderer.AbstractFontRenderer
import it.unimi.dsi.fastutil.floats.FloatArrayList
import it.unimi.dsi.fastutil.ints.IntArrayList
import net.spartanb312.aquarius.util.ColorRGB
import net.spartanb312.aquarius.util.graphics.shaders.DrawShader
import net.spartanb312.aquarius.util.graphics.shaders.use
...
class RenderString(private val string: String) {
    ...
    private object Shader : DrawShader(
        ...
        val defaultColorUniform = glGetUniformLocation(programID, "defaultColor")
