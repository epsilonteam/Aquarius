...
import net.spartanb312.aquarius.util.graphics.ParticleSystem.Companion.distance
import org.lwjgl.opengl.Display
import org.lwjgl.util.vector.Vector2f
import java.util.*

class Particle(var velocity: Vector2f, x: Float, y: Float, var size: Float) {
    var alpha = 0f
        private set
    ...
    private fun getDistanceTo(f: Float, f2: Float): Float {
        return distance(x, y, f, f2).toFloat()
    }
