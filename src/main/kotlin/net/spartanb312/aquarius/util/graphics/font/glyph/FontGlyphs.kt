package net.spartanb312.aquarius.util.graphics.font.glyph

import net.spartanb312.aquarius.util.graphics.font.Style
import net.spartanb312.aquarius.util.graphics.texture.GrayscaleMipmapTexture
import net.spartanb312.aquarius.util.graphics.texture.TextureUtils.getAlpha
import kotlinx.coroutines.launch
import net.spartanb312.aquarius.util.concurrent.BackgroundScope
import net.spartanb312.aquarius.util.concurrent.onMainThreadSuspend
