...
open class GLSLSandbox(fragShaderPath: String) : Shader(DEFAULT_VERTEX_SHADER, fragShaderPath) {
    private val timeUniform = glGetUniformLocation(programID, "time")
    private val mouseUniform = glGetUniformLocation(programID, "mouse")
    private val resolutionUniform = glGetUniformLocation(programID, "resolution")
