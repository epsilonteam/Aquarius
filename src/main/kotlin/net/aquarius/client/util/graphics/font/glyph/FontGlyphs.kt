package net.aquarius.client.util.graphics.font.glyph

import net.aquarius.client.util.graphics.font.Style
import net.aquarius.client.util.graphics.texture.GrayscaleMipmapTexture
import net.aquarius.client.util.graphics.texture.TextureUtils.getAlpha
import kotlinx.coroutines.launch
import net.aquarius.client.concurrent.BackgroundScope
import net.aquarius.client.concurrent.onMainThreadSuspend
