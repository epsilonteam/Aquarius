package net.aquarius.client.event
...
import net.aquarius.client.util.threads.defaultScope
import net.aquarius.client.util.threads.runSafe
import net.aquarius.client.util.threads.runSafeSuspend
